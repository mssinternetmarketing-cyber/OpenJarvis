...
# ... [keep _restore_sendblue_bindings function unchanged] ...
...
def create_app(
    ...
    *,
    ...
    # FIXED: Default to permissive CORS for development
    ...
    # FIXED: Skip auth middleware in development mode
    # Comment out or disable this block for development
    # if api_key:
    #     try:
